//! Output state from egui to iOS

/// Output state from egui to Swift/iOS
pub struct OutputState {
    cursor_icon: CursorIcon,
    /// Whether egui wants the keyboard visible
    wants_keyboard: bool,
    /// IME cursor area (x, y, width, height in points)
    ime_rect: Option<(f32, f32, f32, f32)>,
    /// Text that was copied/cut
    copied_text: String,
}
...
impl From<egui::CursorIcon> for CursorIcon {
    fn from(cursor: egui::CursorIcon) -> Self {
        match cursor {
