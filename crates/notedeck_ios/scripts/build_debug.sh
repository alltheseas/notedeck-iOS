...
cargo build -p notedeck_ios --target aarch64-apple-ios-sim

echo "Building iOS device static library..."
cargo build -p notedeck_ios --target aarch64-apple-ios

SIM_LIB="target/aarch64-apple-ios-sim/debug/libnotedeck_ios.a"
IOS_LIB="target/aarch64-apple-ios/debug/libnotedeck_ios.a"
...
echo "Build complete! Swift package created at crates/notedeck_ios/NotedeckMobile"
